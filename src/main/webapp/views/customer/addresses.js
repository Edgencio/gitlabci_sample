Hi.view(function (_) {
    ...
    _.initMap = function () {
        ...
        //Adding address markers from database
    ...
    _.addAddress = function (address_name, address_description, address_lat, address_lng){
       ...
       CustomerAddressesFrontier.addCustomerAddress(address_name, address_description, address_lat, address_lng).try(function (result) {
           if(result==false){
    ...
    _.showRemoveAddressErrorMessage = function () {
        $.alert({
            title: 'Erro!',
            content: 'Erro ao remover o endereço ',
            type: 'danger',
            buttons: {
                confirm: {
                    text: 'OK',
